...
export function WelcomeScreen() {
  ...
  useEffect(() => {
    // 5 seconds timer for welcome screen animation
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          {/* Centered Responsive Logo Loader */}
          <div className="flex flex-col items-center gap-6">
            ...
            >
              <span className="w-2.5 h-2.5 rounded-full bg-[#FF4D6D] border border-[#111111] animate-pulse" />
