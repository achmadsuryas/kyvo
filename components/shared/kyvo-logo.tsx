...
export function KyvoLogoIcon({ size = 'md', className }: { size?: 'sm' | 'md' | 'lg' | 'xl'; className?: string }) {
  const dimensions = {
    ...
    md: 'w-9 h-9 sm:w-10 sm:h-10 rounded-2xl border-[2.5px] shadow-[2.5px_2.5px_0px_0px_#111111]',
    lg: 'w-12 h-12 sm:w-14 sm:h-14 rounded-2xl border-[3px] shadow-[3.5px_3.5px_0px_0px_#111111]',
    xl: 'w-16 h-16 sm:w-20 sm:h-20 rounded-3xl border-[4px] shadow-[5px_5px_0px_0px_#111111]',
  };
